...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Mar 2025 pada 15.21
...
--
ALTER TABLE `pegawai`
  ADD CONSTRAINT `fk_pegawai_gaji` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`gol`);
COMMIT;
