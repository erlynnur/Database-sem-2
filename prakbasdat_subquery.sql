...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Mar 2025 pada 07.58
...
CREATE TABLE `dosen` (
  ...
  `nama_dos` varchar(30) DEFAULT NULL,
  `alamat_dos` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
